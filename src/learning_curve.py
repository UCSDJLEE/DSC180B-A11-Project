...
def learning_curve(training_rmse, validation_rmse, best_epoch):
	...
	ax.plot(best_epoch+1, validation_rmse[best_epoch], marker='*', markersize=12, color='red', label=f'Best model(Validation RMSE: {round(validation_rmse[best_epoch], 2)}) saved at');
